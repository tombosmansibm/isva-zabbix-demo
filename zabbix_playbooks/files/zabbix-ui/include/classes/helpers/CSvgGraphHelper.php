...
class CSvgGraphHelper {
	...
	public static function get($width, $height, array $options = []) {
		...
		self::getGraphDataSource($metrics, $width, $errors, $options['data_source']);
	 ...
	 */
	protected static function getGraphDataSource(array &$metrics = [], $width, array &$errors = [], $data_source) {
		/**
